...
{
    /// <summary>
    /// ViewModel per la creazione di un nuovo mezzo
    /// </summary>
    public class MezzoCreateViewModel
    {
        ...
        public TipoProprietaMezzo TipoProprieta { get; set; } = TipoProprietaMezzo.Proprieta;
