...
{
    /// <summary>
    /// ViewModel per la modifica di un'Elaborazione Lotto esistente
    /// Include ID e validazioni business logic per prezzi e motivazione
    /// </summary>
    public class ElaborazioneLottoEditViewModel : IValidatableObject
    {
        // ===== IDENTIFICAZIONE =====
        [Required]
